...
if TYPE_CHECKING:
    from rover_sim.missions.base import Mission


@runtime_checkable
class Driver(Protocol):
    """
    A Driver consumes RoverState (plus an optional Mission) and produces
    ...
    Mission is Optional because teleop drivers — the default mode that the
